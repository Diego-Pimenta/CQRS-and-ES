package com.dpa.account.cmd.api.controllers;

import com.dpa.account.cmd.api.commands.OpenAccountCommand;
import com.dpa.account.cmd.api.dto.OpenAccountResponse;
...
public class OpenAccountController {
    ...
    public ResponseEntity<BaseResponse> openAccount(@RequestBody OpenAccountCommand command) {
        ...
        try {
            ...
            return new ResponseEntity<>(new OpenAccountResponse("Bank account creation request successfully!", id), HttpStatus.CREATED);
